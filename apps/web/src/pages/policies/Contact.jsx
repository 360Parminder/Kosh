    ...
    return (
        <div className=" flex flex-col items-center justify-center px-4">
            ...
            <motion.p
                ...
                className="text-black/70 dark:text-white/70 text-center max-w-xl mb-8"
            >
            ...
            <motion.form
                ...
                className="w-full max-w-xl space-y-4 border border-black/20 dark:border-white/20 rounded-xl backdrop-blur-md p-8 shadow-lg"
            >
                <div>
                ...
                <div className="text-center">
                    <button
                        type="submit"
                        className="bg-indigo-600 px-6 py-3 border rounded-lg text-white font-medium  transition-colors"
                    >
                        Send Message
                    </button>
                </div>
