            ...
            <div className="flex justify-center gap-2 px-2 pb-24 -mt-20 perspective-[1000px]">
                ...
                >
                    ...
                    <div className='mt-4 flex justify-center items-center gap-2 text-[13px]'>
                        <span className='p-1.5 rounded-2xl border border-white/60'>Show as List</span>
                        <span className=' flex items-center p-1.5 rounded-2xl border border-white/60'>
                ...
                >
                    <div className='flex items-center justify-between gap-2 mb-2'>
                        <img className='w-8 h-8' src="/src/assets/Mastercard.png" alt="MasterCard" />
                         <span className='p-1 rounded-2xl text-sm border border-white/60'>Show Balance</span>
                    </div>
